...
const SneakersCard: React.FC<IProps> = ({sneakers}) => {
    ...
    return (
            <div className="sneakers-card">
                <div className="sneakers-card__top">
                    <div className="sneakers-card__poster ">
                        <img className="sneakers-card__poster-img" width={133} height={112} src={imageUrl} alt="sneakers_photo"/>
                        <svg className={`sneakers-card__favorite${isFavorite ? '_isFavorite' : ''}`} onClick={addFavorite} width="22" height="19"
                    ...
                    <h3 className="sneakers-card__title">{name}</h3>
                </div>
                <div className="sneakers-card__info">
                    <div className="sneakers-card__info-price">
                        <span className="sneakers-card__info-price--subtext">Price:</span>
                        <span className="sneakers-card__info-price--price_count">{price} UAH</span>
                    </div>
